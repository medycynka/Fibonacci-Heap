...
public:
    ...
    explicit ConstIterator(FiboNode<T> *s)                 : Iter(s), pomHeap(nullptr), wasExtraction(false){};
    explicit ConstIterator(bool &s)                        : Iter(nullptr), pomHeap(nullptr), wasExtraction(s){}
    ConstIterator(FiboNode<T> *s, FiboNode<T> *h)          : Iter(s), pomHeap(h), wasExtraction(false){};
    ConstIterator(FiboNode<T> *s, FiboNode<T> *h, bool &w) : Iter(s), pomHeap(h), wasExtraction(w){};
...
#endif //FIBONACCIHEAP_FIBONACCI_CONST_ITERATOR_HPP
